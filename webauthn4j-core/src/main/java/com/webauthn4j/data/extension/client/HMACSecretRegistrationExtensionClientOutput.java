...
public class HMACSecretRegistrationExtensionClientOutput extends SingleValueExtensionOutputBase<Boolean>
    ...
    public HMACSecretRegistrationExtensionClientOutput(@Nullable Boolean value) {
        super(value);
    }
